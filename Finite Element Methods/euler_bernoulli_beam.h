...
const std::vector<std::array<int, 4>> ELDOF = { {1, 5, 2, 6}, {2, 6, 4, 8}, {4, 8, 3, 7} };  
...
const std::vector<int> RESULTANT_FORCE_NODES = { 1, 2 }; 
...
std::vector<double> compute_resultant_forces(std::pair<std::vector<double>, std::vector<double>>& ); 